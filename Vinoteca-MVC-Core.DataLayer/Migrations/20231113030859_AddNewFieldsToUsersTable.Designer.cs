...
namespace Vinoteca_MVC_Core.DataLayer.Migrations
{
    ...
    [Migration("20231113030859_AddNewFieldsToUsersTable")]
    partial class AddNewFieldsToUsersTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Vinoteca_MVC_Core.Models.Models.Winery", b =>
                {
                    ...
                    b.HasIndex("WineryName")
                        .IsUnique();

                    b.ToTable("Wineries");
                });

            modelBuilder.Entity("Vinoteca_MVC_Core.Models.Models.ApplicationUser", b =>
                {
